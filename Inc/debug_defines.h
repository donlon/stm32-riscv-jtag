#ifndef _DEBUG_DEFINES_H_
#define _DEBUG_DEFINES_H_

#define IR_LENGTH                           5
#define DTM_REG_MASK                        0x1f
...
#define DTM_DMI_ADDRESS_LENGTH              6
#define DTM_DMI_ADDRESS                     (((1L<<6)-1) << DTM_DMI_ADDRESS_OFFSET)
#define DTM_DMI_ADDRESS_MASK                0x3f
/*
...
#define DTM_DMI_DATA_MASK                   0xffffffff

#define DTM_BYPASS                          0x1f

#define DTM_DM_VERSION_013                  0x2
/*
...
#define DTM_DMI_OP_MASK                     0x3
#define DTM_DMI_OP_SUCC                     0x00
#define DTM_DMI_OP_FAIL                     0x02
#define DTM_DMI_OP_BUSY                     0x03

#define DTM_DMI_OP_NOP                      (0x00)
#define DTM_DMI_OP_READ                     (0x01)
#define DTM_DMI_OP_WRITE                    (0x02)
...
#define DMI_COMMAND_CMDTYPE_REG             0x0
#define DMI_COMMAND_CMDTYPE_MEM             0x2

#define DMI_COMMAND_AARSIZE_OFFSET          20
#define DMI_COMMAND_AARSIZE_LENGTH          3
#define DMI_COMMAND_AARSIZE                 (0x7U << DMI_COMMAND_AARSIZE_OFFSET)

#define DMI_COMMAND_AARPOSTINCREMENT_OFFSET 19
#define DMI_COMMAND_AARPOSTINCREMENT_LENGTH 1
#define DMI_COMMAND_AARPOSTINCREMENT        (0x1U << DMI_COMMAND_AARPOSTINCREMENT_OFFSET)

#define DMI_COMMAND_POSTEXEC_OFFSET         18
#define DMI_COMMAND_POSTEXEC_LENGTH         1
#define DMI_COMMAND_POSTEXEC                (0x1U << DMI_COMMAND_POSTEXEC_OFFSET)

#define DMI_COMMAND_TRANSFER_OFFSET         17
#define DMI_COMMAND_TRANSFER_LENGTH         1
#define DMI_COMMAND_TRANSFER                (0x1U << DMI_COMMAND_TRANSFER_OFFSET)

#define DMI_COMMAND_WRITE_OFFSET            16
#define DMI_COMMAND_WRITE_LENGTH            1
#define DMI_COMMAND_WRITE                   (0x1U << DMI_COMMAND_WRITE_OFFSET)

#define DMI_COMMAND_REGNO_OFFSET            0
#define DMI_COMMAND_REGNO_LENGTH            16
#define DMI_COMMAND_REGNO                   (0xffffU << DMI_COMMAND_REGNO_OFFSET)
...
#define DMI_SBCS_SBACCESS_32BIT             0x2
/*
